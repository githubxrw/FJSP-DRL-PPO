...
# args for env
parser.add_argument('--n_j', type=int, default=20, help='Number of jobs of the instance')
parser.add_argument('--n_m', type=int, default=10, help='Number of machines of the instance')
parser.add_argument('--n_op', type=int, default=150, help='Number of operations of the instance')
...
parser.add_argument('--num_mlp_layers_critic', type=int, default=2, help='Number of layers in Critic network')
parser.add_argument('--hidden_dim_critic', type=int, default=32, help='Hidden dimension of Critic network')

# args for PPO Algorithm
parser.add_argument('--num_envs', type=int, default=20, help='Batch size for training environments')
parser.add_argument('--max_updates', type=int, default=2000, help='No. of episodes of each env for training')
...
parser.add_argument('--test_model', nargs='+', default=['20x10'], help='List of model for testing')
